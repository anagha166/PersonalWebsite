  ...
  return (
    <div className="flex justify-center items-center min-h-screen p-4">
      <form className="w-full max-w-mdp-6 rounded-lg">
        ...
        <button className="transform transition-transform hover:translate-y-[5px] shadow-lg ml-8 text-[1vw] border-2 border-amber-50 rounded-full px-8 py-2 text-white mt-8">
          send
        </button>
      </form>
    </div>
